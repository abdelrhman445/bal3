...
export const metadata = {
  title: 'سياسة الخصوصية — بلِّغ',
  description: 'سياسة الخصوصية الخاصة بمنصة بلِّغ',
};
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1 className="hero-title">سياسة <em>الخصوصية</em></h1>
        <p className="hero-date">آخر تحديث: أبريل 2025</p>
      </div>
      <div className="content">
        {[
          { n:'01', t:'المعلومات التي نجمعها', p:['عند إنشاء حساب، نجمع اسم المستخدم، البريد الإلكتروني، وكلمة المرور المشفرة. لا نجمع أي معلومات إضافية عنك.','عند إرسال رسالة عبر بلِّغ، لا يتم تخزين أي بيانات تعريفية عن المرسل مطلقاً.'] },
          { n:'02', t:'كيف نستخدم معلوماتك', p:['نستخدم بريدك الإلكتروني فقط لإرسال كود التفعيل وكود استعادة كلمة المرور. لا نرسل إعلانات أو نشرات بريدية.','اسم المستخدم يُستخدم لإنشاء رابطك الشخصي الفريد.'] },
          { n:'03', t:'مشاركة البيانات مع أطراف ثالثة', p:['لا نبيع، نؤجر، أو نشارك بياناتك الشخصية مع أي طرف ثالث لأغراض تجارية بأي شكل من الأشكال.','قد نشارك بيانات مجهولة ومجمعة (بدون تعريف شخصي) لأغراض إحصائية بحتة.'] },
          { n:'04', t:'أمان البيانات', p:['كلمات المرور مشفرة باستخدام خوارزميات تشفير قوية ولا يمكن لأحد قراءتها حتى من داخل الفريق.','نستخدم بروتوكول HTTPS لتشفير جميع البيانات المنقولة بين متصفحك وخوادمنا.'] },
          { n:'05', t:'حقوقك', p:['يحق لك طلب حذف حسابك وجميع بياناتك المرتبطة به في أي وقت من صفحة الإعدادات أو بالتواصل معنا.','يحق لك طلب نسخة من بياناتك الشخصية المحفوظة لدينا بالتواصل عبر البريد الإلكتروني.'] },
          { n:'06', t:'التواصل معنا', p:['إذا كان لديك أي استفسار بخصوص سياسة الخصوصية، يمكنك التواصل معنا على: gamotek8@gmail.com'] },
        ].map((s,i) => (
          <div className="section" key={i}>
            <h2 className="sec-title"><span className="sec-num">{s.n}</span>{s.t}</h2>
            {s.p.map((p,j) => <p className="sec-text" key={j}>{p}</p>)}
          </div>
        ))}
      </div>
      <footer>
        <span className="ft">© {new Date().getFullYear()} بلِّغ</span>
        <span className="ft"><Link href="/terms">شروط الاستخدام</Link> · <Link href="/safety">الأمان</Link></span>
      </footer>
    </>
  );
}
